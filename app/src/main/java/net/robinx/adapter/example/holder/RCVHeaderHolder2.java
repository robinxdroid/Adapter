...
public class RCVHeaderHolder2 extends RecyclerViewHolderBase<TestBean> {
	private TextView textView;

	private WeakReference<RecyclerHeaderAndFooterActivity> mActivityReference;

	public RCVHeaderHolder2(View itemView) {
		super(itemView);
	}

	public RCVHeaderHolder2(View itemView, RecyclerHeaderAndFooterActivity activity) {
		super(itemView);
