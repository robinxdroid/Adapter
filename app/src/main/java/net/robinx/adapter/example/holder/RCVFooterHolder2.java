...
public class RCVFooterHolder2 extends RecyclerViewHolderBase<TestBean> {
	private TextView textView;

	private WeakReference<RecyclerHeaderAndFooterActivity> mActivityReference;

	public RCVFooterHolder2(View itemView) {
		super(itemView);
	}

	public RCVFooterHolder2(View itemView, RecyclerHeaderAndFooterActivity activity) {
		super(itemView);
